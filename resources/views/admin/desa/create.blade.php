...
@section('header', 'Desa')
@section('breadcrumb', 'Tambah Data Desa')

@section('content')
    <div class="max-w-2xl">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center gap-3 mb-6">
                <a href="{{ route('admin.desa.index') }}" class="p-2 rounded-lg hover:bg-gray-100 transition">
                    <i class="fas fa-arrow-left text-gray-600"></i>
                </a>
                <div>
                    <h3 class="text-lg font-bold text-gray-800">Tambah Desa</h3>
                    <p class="text-sm text-gray-500">Tambah data desa baru</p>
                </div>
            </div>
            ...
            <form action="{{ route('admin.desa.store') }}" method="POST">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="alamat" id="alamat" rows="3"
                            ...
                            placeholder="Masukkan alamat desa">{{ old('alamat') }}</textarea>
                        @error('alamat')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex items-center gap-3 mt-8">
                    ...
                    <a href="{{ route('admin.desa.index') }}" class="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition font-medium">
                        Batal
                    </a>
                </div>
            </form>
