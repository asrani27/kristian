...
@section('breadcrumb', 'Kelola Data Kegiatan')
        ...
        <div class="p-6 border-b border-gray-100">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Kelola data kegiatan desa</p>
                </div>
                    ...
                    @forelse($kegiatans as $index => $kegiatan)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600">
                                <div>
                                    <span class="font-medium">{{ $kegiatan->desa->nama ?? '-' }}</span>
                                    <p class="text-xs text-gray-400">{{ $kegiatan->desa->kecamatan->nama ?? '' }}</p>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-sm text-gray-600">
                                <div>
