...
@section('breadcrumb', 'Tambah Data Kecamatan')
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 class="text-lg font-bold text-gray-800">Tambah Kecamatan</h3>
                    <p class="text-sm text-gray-500">Tambah data kecamatan baru</p>
                </div>
            </div>
