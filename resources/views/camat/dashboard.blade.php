...
@section('breadcrumb', 'Ringkasan Kecamatan')
...
<div class="bg-gradient-to-r from-primary to-secondary rounded-2xl p-6 mb-6 text-white">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h2 class="text-2xl font-bold">{{ $kecamatan->nama ?? 'Kecamatan' }}</h2>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
    ...
    <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-4 lg:px-6 py-4 lg:py-5 border-b border-gray-100 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-0.5">Kegiatan di kecamatan Anda</p>
            </div>
            <a href="{{ route('camat.kegiatan.index') }}" class="text-primary hover:text-sky-600 text-sm font-medium flex items-center gap-1 transition">
                Lihat Semua
    ...
    <div class="space-y-4 lg:space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 lg:p-6">
            ...
            <div class="space-y-3">
                <a href="{{ route('camat.desa.index') }}" class="flex items-center gap-3 p-3 rounded-xl bg-primary/5 hover:bg-primary/10 text-primary transition">
                    <div class="w-10 h-10 bg-primary rounded-lg flex items-center justify-center">
                        <i class="fas fa-home text-white text-sm"></i>
                    </div>
                    <span class="font-medium">Kelola Desa</span>
                </a>
                <a href="{{ route('camat.kegiatan.index') }}" class="flex items-center gap-3 p-3 rounded-xl bg-purple-500/5 hover:bg-purple-500/10 text-purple-600 transition">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 lg:p-6">
            <div class="text-center">
                ...
                <p class="text-sm text-gray-500 capitalize">Camat</p>
