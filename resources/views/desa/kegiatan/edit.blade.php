        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Edit data kegiatan di {{ $desa->nama ?? 'Desa' }}</p>
                </div>
            </div>

            <form action="{{ route('desa.kegiatan.update', $kegiatan->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
