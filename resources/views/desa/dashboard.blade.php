...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
    ...
    <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-4 lg:px-6 py-4 lg:py-5 border-b border-gray-100 flex items-center justify-between">
            ...
            <a href="{{ route('desa.kegiatan.index') }}" class="text-primary hover:text-sky-600 text-sm font-medium flex items-center gap-1 transition">
                Lihat Semua
        ...
        <div class="p-4 lg:p-6">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('desa.kegiatan.create') }}" class="inline-block mt-4 px-4 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:bg-sky-600 transition">
                        Tambah Kegiatan
                    </a>
                </div>
            @endif
    ...
    <div class="space-y-4 lg:space-y-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 lg:p-6">
            ...
            <div class="space-y-3">
                <a href="{{ route('desa.kegiatan.create') }}" class="flex items-center gap-3 p-3 rounded-xl bg-primary/5 hover:bg-primary/10 text-primary transition">
                    <div class="w-10 h-10 bg-primary rounded-lg flex items-center justify-center">
                        <i class="fas fa-plus text-white text-sm"></i>
                    </div>
                    <span class="font-medium">Tambah Kegiatan</span>
                </a>
                <a href="{{ route('desa.kegiatan.index') }}" class="flex items-center gap-3 p-3 rounded-xl bg-purple-500/5 hover:bg-purple-500/10 text-purple-600 transition">
